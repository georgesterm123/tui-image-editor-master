...
var $inputImage = $("[data-tui='input-image-file']");
var $btnDownload = $("[data-tui='btn-download']");

var $btnUndo = $("[data-tui='btn-undo']");
var $btnRedo = $("[data-tui='btn-redo']");
var $btnClearObjects = $("[data-tui='btn-clear-objects']");
var $btnRemoveActiveObject = $("[data-tui='btn-remove-active-object']");
var $btnCrop = $("[data-tui='btn-crop']");
var $btnFlip = $("[data-tui='btn-flip']");
var $btnRotation = $("[data-tui='btn-rotation']");
console.log('---------');
console.log($btnRotation);

// var $btnRotation = $("[data-tui='btn-rotation');
var $btnDrawLine = $("[data-tui='btn-draw-line']");
var $btnDrawShape = $("[data-tui='btn-draw-shape']");
var $btnApplyCrop = $("[data-tui='btn-apply-crop']");
var $btnCancelCrop = $("[data-tui='btn-cancel-crop']");
var $btnFlipX = $("[data-tui='btn-flip-x']");
var $btnFlipY = $("[data-tui='btn-flip-y']");
var $btnResetFlip = $("[data-tui='btn-reset-flip']");
var $btnRotateClockwise = $("[data-tui='btn-rotate-clockwise']");
var $btnRotateCounterClockWise = $("[data-tui='btn-rotate-counter-clockwise']");
var $btnText = $("[data-tui='btn-text']");
var $btnTextStyle = $('.btn-text-style');
var $btnAddIcon = $("[data-tui='btn-add-icon']");
var $btnRegisterIcon = $("[data-tui='btn-register-icon']");
var $btnMaskFilter = $("[data-tui='btn-mask-filter']");
var $btnImageFilter = $("[data-tui='btn-image-filter']");
var $btnLoadMaskImage = $("[data-tui='input-mask-image-file']");
var $btnApplyMask = $("[data-tui='btn-apply-mask']");
var $btnClose = $('.close');

// Input etc.
var $inputRotationRange = $("[data-tui='input-rotation-range']");
var $inputBrushWidthRange = $("[data-tui='input-brush-width-range']");
var $inputFontSizeRange = $("[data-tui='input-font-size-range']");
var $inputStrokeWidthRange = $("[data-tui='input-stroke-width-range']");
var $inputCheckTransparent = $("[data-tui='input-check-transparent']");
var $inputCheckFilter = $("[data-tui='input-check-filter']");
var $inputCheckGrayscale = $("[data-tui='input-check-grayscale']");
var $inputCheckInvert = $("[data-tui='input-check-invert']");
var $inputCheckSepia = $("[data-tui='input-check-sepia']");
var $inputCheckSepia2 = $("[data-tui='input-check-sepia2']");
var $inputCheckBlur = $("[data-tui='input-check-blur']");
var $inputCheckSharpen = $("[data-tui='input-check-sharpen']");
var $inputCheckEmboss = $("[data-tui='input-check-emboss']");
var $inputCheckRemoveWhite = $("[data-tui='input-check-remove-white']");
var $inputRangeRemoveWhiteThreshold = $("[data-tui='input-range-remove-white-threshold']");
var $inputRangeRemoveWhiteDistance = $("[data-tui='input-range-remove-white-distance']");
var $inputCheckBrightness = $("[data-tui='input-check-brightness']");
var $inputRangeBrightnessValue = $("[data-tui='input-range-brightness-value']");
var $inputCheckNoise = $("[data-tui='input-check-noise']");
var $inputRangeNoiseValue = $("[data-tui='input-range-noise-value']");
var $inputCheckPixelate = $("[data-tui='input-check-pixelate']");
var $inputRangePixelateValue = $("[data-tui='input-range-pixelate-value']");
var $inputCheckTint = $("[data-tui='input-check-tint']");
var $inputRangeTintOpacityValue = $("[data-tui='input-range-tint-opacity-value']");
var $inputCheckMultiply = $("[data-tui='input-check-multiply']");
var $inputCheckBlend = $("[data-tui='input-check-blend']");
var $inputCheckColorFilter = $("[data-tui='input-check-color-filter']");
var $inputRangeColorFilterValue = $("[data-tui='input-range-color-filter-value']");

// Sub menus
var $displayingSubMenu = $();
var $cropSubMenu = $("[data-tui='crop-sub-menu']");
var $flipSubMenu = $("[data-tui='flip-sub-menu']");
var $rotationSubMenu = $("[data-tui='rotation-sub-menu']");
var $freeDrawingSubMenu = $("[data-tui='free-drawing-sub-menu']");
var $drawLineSubMenu = $("[data-tui='draw-line-sub-menu']");
var $drawShapeSubMenu = $("[data-tui='draw-shape-sub-menu']");
var $textSubMenu = $("[data-tui='text-sub-menu']");
var $iconSubMenu = $("[data-tui='icon-sub-menu']");
var $filterSubMenu = $("[data-tui='filter-sub-menu']");
var $imageFilterSubMenu = $("[data-tui='image-filter-sub-menu']");
